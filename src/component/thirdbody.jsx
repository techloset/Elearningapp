...
const Thirdbody = () => {
  return (
    <div className="  mt-[190px]   ">
      ...
      <div className="flex max-xl:flex-wrap max-xl:w-[100%] w- justify-between ml-[317px] mr-[265px]  pt-[177px] items-center ">
      ...
      <div className=" flex justify-center pt-[150px] ">
        <button className="font-[400] text-[24px] rounded-[80px] border-[1px] border-[#49BBBD] w-[280px] h-[80px] text-[#49BBBD] ">
          See more features
        </button>
      </div>
    </div>
