...
const Course = () => {
  return (
    <div>
      <Slider3 />
      <p className="font-poppins font-[600] text-[36px] text-[#252641] ml-[120px]">
      ...
      <div>
        <p className="font-poppins font-[500px] text-[30px] leading-[45px] ml-[6.77%] pt-[90px] ">
          Get choice of your course
        </p>
      </div>
      <div className="flex justify-center gap-[50px] pt-[50px] items-center">
      ...
      <div>
        <div className="flex justify-center pt-[90px]">
          <div className="w-[1682px] h-[459px] bg-[#252641] flex flex-col   items-center pt-[70px] rounded-[37px]  ">
            <p className="font-poppins text-white  font-[400] text-[36px] leading-[54px]  ">
              Online coaching lessons for remote learning.
            </p>
            <p className="font-poppins text-[24px] leading-[43px] text-white w-[1259px] pt-[30px]     ">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
        ...
        <div className="w-[1920px] h-[946px] bg-[#9DCCFF] bg-opacity-[0.2] pt-[90px] ">
          <div className="ml-[7%] pt-[90px] ">
            <p className="font-poppins font-[500] text-[30px] leading-[45px] ">
              Student are viewing
            </p>
